...
def upload(request):
    ...
    s3_client.upload_file(Filename=os.path.join(os.getcwd(), 'test_audio.wav'), Bucket='test-speechcapture', Key='test_audio.wav')
...
def transcript(request, fileName):
    ...
    return render(request, 'webapp/transcript.html')
